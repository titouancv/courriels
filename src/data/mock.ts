...
export const mockEmails: Email[] = [
  {
    ...
    preview: 'The new cycle has begun. Check out the team goals and assigned tasks.',
    messages: [
      {
        id: '1',
        sender: {
  ...
  },
  {
    ...
    preview: 'I have attached the latest Figma links for the dashboard redesign. Let me know what you think.',
    messages: [
      {
        id: '2a',
        sender: {
  ...
  },
  {
    ...
    preview: 'This week we dive deep into RSC and what it means for the ecosystem.',
    messages: [
      {
        id: '3',
        sender: {
